...
const UpcomingEvents = () => {
  ...
  return (
    <div data-aos="fade-up" className="relative text-center shadow-2xl rounded-xl overflow-hidden border-white border-2 m-4 lg:max-w-[30%] bg-teal-400/40 aos-init">
